...
const imagePath = './public/adsImg.jpg'
const fontPath = './public/fonts/Inter_28pt-Bold.ttf'

registerFont(fontPath, { family: 'Inter' });


function imageGenerationAds(categoryTitle, price_from = 0, price_to = 0) {
    ...
    loadImage(imagePath).then((image) => {
        ...
        ctx.fillText(`E’lon / ${detectLanguage(categoryTitle)}`, 100, 500) 
...
module.exports = imageGenerationAds